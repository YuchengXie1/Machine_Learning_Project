...
I believe out-of sample errors exist because the accuracy of prediction in testing sets are much lower than the accuracy when doing cross validation.
Maybe the samples in testing set is different in time with those in training set.
I am not prettey sure.
